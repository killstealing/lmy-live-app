...
// */
//@Configuration
//public class SendGiftConsumer1 implements InitializingBean {
//
...
//
//
//    private static final Logger LOGGER = LoggerFactory.getLogger(SendGiftConsumer1.class);
//
//    @Resource
...
//        mqPushConsumer.setConsumerGroup(rocketMQConsumerProperties.getGroupName() + "_" + SendGiftConsumer1.class.getSimpleName());
...
//                    } else {
//                        this.pkImMsgSend(jsonObject, sendGiftMq, sendGiftMq.getReceiverId());
//                    }
//                } else {
