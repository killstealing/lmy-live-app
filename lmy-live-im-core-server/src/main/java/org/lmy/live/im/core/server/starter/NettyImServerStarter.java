...
//import org.lmy.live.im.core.server.handler.tcp.TcpImServerCoreHandler;
...
//                //设置这个netty处理handler
//                channel.pipeline().addLast(applicationContext.getBean(TcpImServerCoreHandler.class));
//            }
//        });
//        //基于JVM的钩子函数去实现优雅关闭
...
//
//        // JVM 参数
//        // - DUBBO_IP_TO_REGISTRY=192.168.3.26 DUBBO_PORT_TO_REGISTRY=9096
//        //获取im服务的注册ip和暴露端口
...
//        String registryIp="192.168.3.26";
//        String registryPort="9096";
